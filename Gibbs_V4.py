                ...
                if self.Barostat != True:
                    ...
                    #update species                               
                            ...
                            if indx - 1 in self.NeutralSpecies: 
                                ...
                                self.Write2Log('muI - mu II = {} - {} = {}\n'.format(self.OperatorsCurrent[8+4*(indx-1)],self.OperatorsCurrent[8+4*(indx-1)+2],self.DvalsCurrent[indx+1]))
